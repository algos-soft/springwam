 ...
 */
@SpringView(name = AppCost.TAG_CRO)
@AIEntity(roleTypeVisibility = ARoleType.developer)
public class CroceNavView extends AlgosNavView {
     ...
     */
    public CroceNavView(@Qualifier(AppCost.TAG_CRO) AlgosPresenterImpl presenter) {
        super(presenter);
