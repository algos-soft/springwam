...
@SpringView(name = AppCost.VIEW_CRO_FORM)
@AIScript(sovrascrivibile = true)
public class CroceForm extends AForm {
     ...
     */
     public CroceForm(@Lazy @Qualifier(AppCost.TAG_CRO) IAPresenter presenter, @Qualifier(ACost.BAR_FORM) IAToolbar toolbar) {
