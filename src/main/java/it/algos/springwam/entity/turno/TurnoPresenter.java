...
@Slf4j
public class TurnoPresenter extends AlgosPresenterImpl {
     ...
     */
    public TurnoPresenter(@Qualifier(AppCost.TAG_TUR) AlgosView view, @Qualifier(AppCost.TAG_TUR) AlgosService service, AlgosSearch search) {
