 ...
 */
@SpringView(name = AppCost.TAG_UTE)
@AIEntity(roleTypeVisibility = ARoleType.admin)
public class UtenteNavView extends AlgosNavView {
     ...
     */
    public UtenteNavView(@Qualifier(AppCost.TAG_UTE) AlgosPresenterImpl presenter) {
        super(presenter);
