 ...
 */
@SpringView(name = AppCost.TAG_ISC)
@AIEntity(roleTypeVisibility = ARoleType.developer)
public class IscrizioneNavView extends AlgosNavView {


    //--nome usato da SpringNavigator e dal Menu per selezionare questa vista
    public static final String VIEW_NAME = AppCost.TAG_ISC;
     ...
     */
    public IscrizioneNavView(@Qualifier(AppCost.TAG_ISC) AlgosPresenterImpl presenter) {
        super(presenter);
