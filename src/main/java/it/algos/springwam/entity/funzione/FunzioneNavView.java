 ...
 */
@SpringView(name = AppCost.TAG_FUN)
@AIEntity(roleTypeVisibility = ARoleType.user)
public class FunzioneNavView extends AlgosNavView {
     ...
     */
    public FunzioneNavView(@Qualifier(AppCost.TAG_FUN) AlgosPresenterImpl presenter) {
        super(presenter);
