...
import it.algos.springvaadin.toolbar.ADialogToolbar;
...
public abstract class ADialog extends Window {
	protected Component detail;
	private ADialogToolbar toolbar;
	 ...
	 */
	protected ADialogToolbar createToolbarComponent() {
		return new ADialogToolbar();
	}
	...
	public ADialogToolbar getToolbar() {
		return toolbar;
	}
