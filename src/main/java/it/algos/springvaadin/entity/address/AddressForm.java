...
@SpringView(name = ACost.VIEW_ADD_FORM)
@AIScript(sovrascrivibile = true)
public class AddressForm extends AForm {
     ...
     */
     public AddressForm(@Lazy @Qualifier(ACost.TAG_ADD) IAPresenter presenter, @Qualifier(ACost.BAR_FORM) IAToolbar toolbar) {
