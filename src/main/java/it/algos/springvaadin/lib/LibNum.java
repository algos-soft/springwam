...
public abstract class LibNum {
    ...
    /**
     * Aggiunta di eventuali zeri
     *
     * @param num da formattare
     *
     * @return stringa formattata
     */
    public static String addZeri(int num) {
        return addZeri(num, 2);
    }// end of static method
     ...
     *
     * @param num   da formattare
     * @param cifre numero fisso di cifre, con o senza zero
     *
     * @return stringa formattata
     */
    public static String addZeri(int num, int cifre) {
        String value = num + "";


        if (value.length() < cifre) {
            value = "0" + value;
        }// end of if cycle
